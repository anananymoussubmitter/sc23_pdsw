...
QUERY2='{"query":{"term":{"BodyPart":"Head"}}}'
QUERY3='{"query":{"match_phrase":{"SystemVendor":"Siemens"}}}'
QUERY4='{"query":{"range":{"PatientAge":{"gte":50,"lt":60}}}}'
QUERY5='{"query":{"bool":{"must":[{"term":{"BodyPart":"Head"}},{"term":{"KspacePhaseEnc1":256}},{"term":{"KspacePhaseEnc2":256}}]}}}'
QUERY6='{"query":{"bool":{"must":[{"term":{"BodyPart":"Head"}},{"bool":{"should":[{"bool":{"must":[{"term":{"SystemVendor":"Siemens"}},{"match":{"ProtocolName":"Siemens3"}}]}},{"bool":{"must":[{"term":{"SystemVendor":"GE"}},{"match":{"ProtocolName":"GE3"}}]}}]}}]}}}'
INDEX_NAME="mrirally"
WARMUP_RUNS=25
RUNS=50
# SETTINGS END
