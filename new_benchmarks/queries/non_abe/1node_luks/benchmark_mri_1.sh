...
QUERY2='{"query":{"range":{"PatientAge":{"gte":50,"lt":60}}}}'
QUERY4='{"query":{"term":{"BodyPart":"Head"}}}'
...
#QUERY6='{"query":{"bool":{"must":[{"term":{"BodyPart":"Head"}},{"bool":{"should":[{"bool":{"must":[{"term":{"SystemVendor":"Siemens"}},{"match":{"ProtocolName":"Siemens3"}}]}},{"bool":{"must":[{"term":{"SystemV$
INDEX_NAME="mrirally"
WARMUP_RUNS=25
RUNS=50
# SETTINGS END
