...
# Where we save
#RESULT_PATH="./resultcurl/${BENCHMARK_TYPE}/${ENCRYPTION_TYPE}/${CLUSTER_SIZE}/"
RESULT_PATH="../non_abe/resultcurl/eth/$QUERY/$RUN/${BENCHMARK_TYPE}/${ENCRYPTION_TYPE}/${CLUSTER_SIZE}/"
mkdir -p $RESULT_PATH
